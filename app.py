...
def generate_ideas(niche: str, goals: str = "") -> str:
    ...
    """
    if not niche.strip():
        return "⚠️ Please describe your niche first!"
    ...
    try:
        ...
        for tip in relevant_tips[:3]:
            output += f"• **{tip['category'].upper()}**: {tip['content'][:100]}...\n"
...
with gr.Blocks(css=custom_css, title="TikTok Creator Copilot", theme=gr.themes.Base()) as demo:
    ...
    gr.Markdown(
        ...
        1. **Retrieval** → Searches 20+ TikTok best practices for your niche
        2. **Augmentation** → Adds relevant tips as context to AI prompt
        3. **Generation** → Claude creates personalized ideas using best practices

        **Knowledge Base:** Hooks • Retention • Editing • Captions • Niche Tips
        """,
        elem_id="info"
    )
...
if __name__ == "__main__":
    print("🚀 Starting TikTok Creator Copilot...")
    print("🔑 Make sure you've set your ANTHROPIC_API_KEY at the top of this file!")
